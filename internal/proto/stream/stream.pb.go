...
type Record struct {
	...
	Epoch         int64  `protobuf:"varint,35,opt,name=epoch,proto3" json:"epoch,omitempty"`                          // barrier id
...
const file_stream_stream_proto_rawDesc = "" +
	"\n" +
	"\x13stream/stream.proto\x12\x06stream\"\xfe\x01\n" +
	"\x06Record\x12\x0e\n" +
	...
	"\x05count\x18\f \x01(\x03R\x05count\x12\x1d\n" +
	"\n" +
	"is_barrier\x18\x1e \x01(\bR\tisBarrier\x12\x14\n" +
	"\x05epoch\x18# \x01(\x03R\x05epoch\"-\n" +
	"\x03Ack\x12\x0e\n" +
